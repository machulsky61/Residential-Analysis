...
TEST(costoSubsidioMejoraTEST, demasiadasHabitaciones) {

    eph_h th = {{22114, 2020,   3,  319611, 629088, 1,  41, 0,  1,  100,  99,  2}, // 1 habitante
                {31117, 2020,   3,  332870, 642475, 1,  40, 0,  1,  100,  99,  2}, // 9 habitantes
                {22866, 2020,   3,  317157, 627217, 1,  42, 1,  1,  100,  99,  2}, // 2 habitantes
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  100,  99,  2}};// 2 habitantes
...
TEST(costoSubsidioMejoraTEST, surtidito) {

    eph_h th = {{22114, 2020,   3,  319611, 629088, 1,  41, 0,  1,  10,  1,  2}, // 1 habitante
                {31117, 2020,   3,  332870, 642475, 1,  40, 0,  1,  4,  2,  2}, // 9 habitantes
                {22866, 2020,   3,  317157, 627217, 1,  42, 1,  1,  2,  2,  2}, // 2 habitantes
                {20957, 2020,   3,  313965, 623297, 1,  43, 0,  1,  5,  1,  2}};// 2 habitantes
